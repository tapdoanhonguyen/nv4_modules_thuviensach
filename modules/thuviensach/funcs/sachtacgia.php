...
->where('tacgia_id='.$info_tacgia['id']);
...
$contents = nv_theme_thuviensach_sachtacgia($info_tacgia,$base_url,$num_items,$per_page,$page,$sth);
$page_title=$info_tacgia['name_tacgia'];
