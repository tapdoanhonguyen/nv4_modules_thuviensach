...
<div class="panel panel-default">
    <div class="panel-heading">
        ...
        <div class="pull-right">
            ...
            <a href="{cat_add}" data-toggle="tooltip" data-placement="top" title="{LANG.cat_add}" class="btn btn-success btn-sm"><i class="fa fa-plus-circle" aria-hidden="true"></i></a>
        </div>
        ...
        <table class="table table-striped table-bordered table-hover">
            <thead>
                <tr>
                    ...
                    <th class="text-center" style="vertical-align: middle;">{LANG.name_cat}</th>
                ...
                <tr>
                    ...
                    <td class="text-center" style="vertical-align: middle;"> 
                        <a href="{VIEW.link_view}">
                            {VIEW.name_cat}
                            <span class="red">({VIEW.count})</span>
                        </a> 
                    </td>
                    ...
                    <td class="text-center" style="vertical-align: middle;"><i class="fa fa-edit fa-lg">&nbsp;</i> <a href="{VIEW.link_edit}">{LANG.edit}</a> - <em class="fa fa-trash-o fa-lg">&nbsp;</em> <a href="{VIEW.link_delete}" onclick="return confirm(nv_is_del_confirm[0]);">{LANG.delete}</a></td>
                </tr>
                <!-- END: loop -->
            </tbody>
        </table>
