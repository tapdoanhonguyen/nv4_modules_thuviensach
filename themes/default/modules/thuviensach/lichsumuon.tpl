			...
			<div class="row">
				...
				<div class="col-xs-24 col-sm-12  col-md-6  col-lg-6">
					<div class="form-group">
						...
						placeholder="{LANG.ma_muonsach}" />
					</div>
				</div>
				<div class="col-xs-24 col-sm-12  col-md-2  col-lg-2">
					<div class="form-group">
		...
		<table class="table table-striped table-bordered table-hover">
			<thead>
				<tr>
					...
					<th class="text-center" style="vertical-align: middle;">{LANG.ma_muonsach}</th>
					<th class="text-center" style="vertical-align: middle;">
						Thư viện mượn
					</th>
					<th class="text-center w150" style="vertical-align: middle;">{LANG.name_muon}</th>
			...
			<tbody>
				...
				<tr>
					...
					<td class="text-center" style="vertical-align: middle;"> {VIEW.ma_muonsach} </td>
					<td class="text-center" style="vertical-align: middle;"> {VIEW.thuvien_id} </td>
					...
					<td class="text-center" style="vertical-align: middle;"> {VIEW.status_name} </td>
