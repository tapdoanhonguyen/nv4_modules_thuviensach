		...
		<form method="get" action="{NV_BASE_SITEURL}index.php">
			...
			<div class="row">
				...
				<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2 mb-3">
					<input type="submit" class="btn btn-primary btnhover" value="Tìm kiếm" />
				</div>
			</div>
		</form>
	</div>
	...
	<div class="col-book style-1">
		<div class="dz-shop-card style-1">
			...
			<div class="bookmark-btn style-2">
				<input class="form-check-input" type="checkbox" id="flexCheckDefault_{VIEW.id}" {VIEW.checked} />
				<label class="form-check-label" for="flexCheckDefault_{VIEW.id}" onclick="yeu_thich(this,{VIEW.id})">
					<i class="flaticon-heart"></i>
				</label>
			</div>
			<div class="dz-content">
				<h5 class="title"><a href="{VIEW.alias}">{VIEW.name_sach}</a></h5>
				<ul class="dz-tags">
					<li><a href="{VIEW.cat_link}">{VIEW.cat_title}</a></li>
				</ul>
				<ul class="dz-rating">
